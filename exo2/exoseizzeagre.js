...
async function main() {
    ...
    try {
        ...
        // Agrégation pour trouver le film avec le résumé contenant "la guerre du Vietnam"
        const result = [
            { 
                $match: { 
                    summary: { $regex: "la guerre du Vietnam", $options: "i" } // Recherche de motif insensible à la casse
                } 
            },
            { 
                $project: { 
